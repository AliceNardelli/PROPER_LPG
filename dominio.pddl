...
(:durative-action reaching_production_room
        ...
        :effect
                (and    
                        (at end (not (at ?l1)))
                        (at end (at ?l2))
                        (at end (decrease (interaction_level)(*(extroversion_coefficient)10)))
                )
)
...
(:durative-action present_assembly_room
        ...
        :effect
                (and
                        (at end (decrease (interaction_level)(*(extroversion_coefficient)7)))
...
(:durative-action ask_pick_the_block
        ...
        :effect
                (and
                        (at end (decrease (interaction_level)(*(extroversion_coefficient)5)))
